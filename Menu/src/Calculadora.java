...
public class Calculadora extends JDialog{
	...
	public Calculadora() {
		...
		dialogo.setIcon(new ImageIcon("img/monokuma/dialogo.png"));
		this.add(dialogo);
		...
		mono.setIcon(new ImageIcon("img/monokuma/normal2.png"));
		this.add(mono);
		
		ImageIcon img = new ImageIcon("img/monokuma/aha.png");
		...
		btSoma.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(valido(tfN1.getText(), tfN2.getText())) {
					...
					double x = n1+n2;
					lbRes.setText("<html><body><center>O resultado é... <span style=\"color:'rgb(173,30,36);'\">"+x+"</span>! <br> "
							+ "Parece que você escapou de <br>"
							+ " uma armadilha <br>"
							+ "matemática dessa vez!</center></body></html>");
					lbRes.setBounds(365,60,300,95);
					mono.setIcon(new ImageIcon("img/monokuma/ownt2.png"));
					...
					mono.setIcon(new ImageIcon("img/monokuma/bravo2.png"));
			...
			public void actionPerformed(ActionEvent e) {
				if(valido(tfN1.getText(), tfN2.getText())) {
					...
					if(n2 == 0) {
						...
						mono.setIcon(new ImageIcon("img/monokuma/medo2.png"));
						mono.setBounds(610, 50, 394, 300);
					} else {
						double x = n1/n2;
						lbRes.setText("<html><body><center>O resultado é... <span style=\"color:'rgb(173,30,36);'\">"+x+"</span>! <br> "
