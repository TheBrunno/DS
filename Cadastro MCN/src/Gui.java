...
public class Gui extends JFrame {
	public Gui() {
		...
		ImageIcon image = new ImageIcon("img\\steve.png");
		...
		ImageIcon image2 = new ImageIcon("img\\zombie.png");
		...
		ImageIcon image3 = new ImageIcon("img\\skeleton.png");
		...
		ImageIcon image4 = new ImageIcon("img\\creeper.png");
		...
		ImageIcon image5 = new ImageIcon("img\\wither_skeleton.png");
		...
		ImageIcon image6 = new ImageIcon("img\\piglin.png");
		...
		String[] imagensDimensao = {"img\\overworld.png", "img\\\\nether.png", "img\\\\the_end.png"};
		...
		ImageIcon imagePerfil = new ImageIcon("img\\steve.png");
		...
		btnConfirm.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(dimensao2.getSelectedIndex()==0) {
					...
					ImageIcon imagebgPerfil = new ImageIcon("img\\nether.png");
					Image bgResizor = imagebgPerfil.getImage().getScaledInstance(bgPerfil.getWidth(), bgPerfil.getHeight(), Image.SCALE_SMOOTH);
					ImageIcon bgResized = new ImageIcon(bgResizor);
					bgPerfil.setIcon(bgResized);
				}else if(dimensao2.getSelectedIndex()==2) {
					ImageIcon imagebgPerfil = new ImageIcon("img\\the_end.png");
					Image bgResizor = imagebgPerfil.getImage().getScaledInstance(bgPerfil.getWidth(), bgPerfil.getHeight(), Image.SCALE_SMOOTH);
					ImageIcon bgResized = new ImageIcon(bgResizor);
					bgPerfil.setIcon(bgResized);
				}
